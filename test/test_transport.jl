...
@testset "transport!" begin
    ...
    @testset "diffusivity field: array/closure match the scalar" begin
        ...
        # constant array/closure must reproduce the scalar-D result
        # (the spatially-varying scalar-transport path RANS relies on).
        N = (16, 16); Ng = N .+ 2
        φ = zeros(Float32, Ng)
        for I in CartesianIndices(φ)
        ...
        # a non-uniform diffusivity field must change the result
