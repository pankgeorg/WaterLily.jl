# Regression test for the scalar transport! helper (PLAN 1, Hook 2).
#
# Run as:
#   JULIA_NUM_THREADS=1 julia --project=. test/transport_test.jl
#
# transport!(r, φ, u, Φ; D_diff, λ, perdir) computes the cell-centered
...
@testset "Hook 2: transport!" begin
